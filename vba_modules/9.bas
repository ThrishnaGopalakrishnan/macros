...
Public Sub itemlengthwidththickness()
    ...
    Sheets("constraint").Cells(3, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(4, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(5, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(6, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(7, 2).Value = "length.unit"
    ...
    Sheets("constraint").Cells(8, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(9, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(10, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(11, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(12, 2).Value = "width.unit"
