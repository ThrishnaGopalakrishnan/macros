...
Public Sub itemwidthheightthickness()
    ...
    Sheets("constraint").Cells(3, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(4, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(5, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(6, 2).Value = "width.value"
    ...
    Sheets("constraint").Cells(7, 2).Value = "width.unit"
    ...
    Sheets("constraint").Cells(8, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(9, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(10, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(11, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(12, 2).Value = "height.unit"
    ...
    Sheets("constraint").Cells(13, 1).Value = Worksheets("attribute").Cells(13, 3).Value
    Sheets("constraint").Cells(13, 2).Value = "thickness.value"
    Sheets("constraint").Cells(13, 3).Value = "10480"
    Sheets("constraint").Cells(13, 4).Value = "contributor"
    Sheets("constraint").Cells(13, 5).Value = "PRODUCT"
    Sheets("constraint").Cells(13, 6).Value = "min_value"
    Sheets("constraint").Cells(13, 9).Value = "Insert"
    Sheets("constraint").Cells(14, 1).Value = Worksheets("attribute").Cells(13, 3).Value
    Sheets("constraint").Cells(14, 2).Value = "thickness.value"
    Sheets("constraint").Cells(14, 3).Value = "10480"
    Sheets("constraint").Cells(14, 4).Value = "contributor"
    Sheets("constraint").Cells(14, 5).Value = "PRODUCT"
    Sheets("constraint").Cells(14, 6).Value = "max_value"
    Sheets("constraint").Cells(14, 9).Value = "Insert"
    Sheets("constraint").Cells(15, 1).Value = Worksheets("attribute").Cells(13, 3).Value
    Sheets("constraint").Cells(15, 2).Value = "thickness.value"
    Sheets("constraint").Cells(15, 3).Value = "10480"
    Sheets("constraint").Cells(15, 4).Value = "contributor"
    Sheets("constraint").Cells(15, 5).Value = "PRODUCT"
    Sheets("constraint").Cells(15, 6).Value = "max_scale"
    Sheets("constraint").Cells(15, 9).Value = "Insert"
    Sheets("constraint").Cells(16, 1).Value = Worksheets("attribute").Cells(13, 3).Value
    Sheets("constraint").Cells(16, 2).Value = "thickness.value"
    Sheets("constraint").Cells(16, 3).Value = "10480"
    Sheets("constraint").Cells(16, 4).Value = "contributor"
    Sheets("constraint").Cells(16, 5).Value = "PRODUCT"
    Sheets("constraint").Cells(16, 6).Value = "max_precision"
    Sheets("constraint").Cells(16, 8).Value = 12
    Sheets("constraint").Cells(16, 9).Value = "Insert"
    Sheets("constraint").Cells(17, 1).Value = Worksheets("attribute").Cells(13, 3).Value
    Sheets("constraint").Cells(17, 2).Value = "thickness.unit"
    Sheets("constraint").Cells(17, 3).Value = "10480"
    Sheets("constraint").Cells(17, 4).Value = "contributor"
    Sheets("constraint").Cells(17, 5).Value = "PRODUCT"
    Sheets("constraint").Cells(17, 6).Value = "enumeration"
    Sheets("constraint").Cells(17, 9).Value = "Insert"
End Sub
