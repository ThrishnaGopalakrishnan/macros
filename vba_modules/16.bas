...
Public Sub itemwidthdiameterheight()
    ...
    Sheets("constraint").Cells(8, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(9, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(10, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(11, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(12, 2).Value = "diameter.unit"
    ...
    Sheets("constraint").Cells(13, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(14, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(15, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(16, 2).Value = "height.value"
    ...
    Sheets("constraint").Cells(17, 2).Value = "height.unit"
