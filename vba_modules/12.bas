...
Public Sub itemlengthwidthdepth()
    ...
    Sheets("constraint").Cells(3, 2).Value = "depth.value"
    ...
    Sheets("constraint").Cells(4, 2).Value = "depth.value"
    ...
    Sheets("constraint").Cells(5, 2).Value = "depth.value"
    ...
    Sheets("constraint").Cells(6, 2).Value = "depth.value"
    ...
    Sheets("constraint").Cells(7, 2).Value = "depth.unit"
    ...
    Sheets("constraint").Cells(13, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(14, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(15, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(16, 2).Value = "length.value"
    ...
    Sheets("constraint").Cells(17, 2).Value = "length.unit"
