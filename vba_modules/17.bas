...
Public Sub itemdiameterthickness()
    ...
    Sheets("constraint").Cells(3, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(4, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(5, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(6, 2).Value = "diameter.value"
    ...
    Sheets("constraint").Cells(7, 2).Value = "diameter.unit"
